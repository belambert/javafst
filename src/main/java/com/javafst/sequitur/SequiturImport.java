...
public class SequiturImport {
    ...
    public static class FSA {
        ...
        List<State> states;
        transient List<com.javafst.State> openFstStates;
        ...
        public Fst toFst() {
            ...
            openFstStates = new ArrayList<com.javafst.State>(
                    states.size());
            for (State state : states) {
                com.javafst.State openFstState = state
    ...
    public static class State {
         ...
         * arcs
         */
        public com.javafst.State toUnconnectedOpenFstState() {
            return new com.javafst.State(weight != null ? weight : 0.f);
        }
         ...
         */
        public void connectStates(List<com.javafst.State> openFstStates) {
            if (arcs != null)
                for (Arc arc : arcs) {
                    com.javafst.Arc openFstArc = arc
    ...
    public static class Arc {
        ...
        public com.javafst.Arc toOpenFstArc(
                List<com.javafst.State> openFstStates) {
            return new com.javafst.Arc(in, out, weight,
